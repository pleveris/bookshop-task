        ...
        <div class="comment-widgets">
            <!-- Comment Row -->
                <form @submit.prevent="submit_form()"> 
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="message">Additional comment:</label>
                        <div class="col-md-12">
                        <textarea class="form-control" id="message" v-model="fields.comment" placeholder="Type a comment..." rows="5"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    methods:{
      submit_form(){
        ...
        axios.post(`/api/v1/reviews/store/${this.book.id}`, this.fields)
          .then( ( response ) => {
            this.success = 'Review posted successfully.';
