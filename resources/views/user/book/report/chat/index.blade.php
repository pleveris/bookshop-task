    ...
    <div class="row justify-content-center rounded">
        <div class="col-8 p-4 m-2 bg-warning text-dark rounded">
                    ...
                    <div class="msg-wrap">
                        <div class="media msg">
                            <div class="media-body">
                                ...
                                <h5 class="media-heading"><p class="text-primary"> Admin, </p>{{ $message->user->name}}</h5>
            ...
            <form method="POST" action="{{ route('report.message.store', ['report' => $report ])}}">
                ...
                <div class="btn-panel">
                    <button type="submit" class="col-lg-12 text-center mt-1 btn-block btn-primary" role="button"><i class="fa fa-plus"></i> Send</button>
                </div>
            </form>
        </div>
    </div>
